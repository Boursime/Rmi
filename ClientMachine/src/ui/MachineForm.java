...
public class MachineForm extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Informations machine", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 14))); // NOI18N
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Actions", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 18))); // NOI18N

        bnAdd.setBackground(new java.awt.Color(204, 204, 204));
        bnAdd.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        ...
        bnUpdate.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        ...
        bnDelete.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
    ...
    private void bnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bnAddActionPerformed
        try {
            ...
            JOptionPane.showMessageDialog(this, "Machine successfully added");
            load();
        } catch (RemoteException ex) {
            Logger.getLogger(MachineForm.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    if (selectedRow >= 0) {
        ...
        try {
            ...
            if (updated) {
                ...
                txtMarque.setText("");
                txtPrix.setText("");
                JOptionPane.showMessageDialog(this, "Machine successfully updated");
                load();
            } else {
        ...
        if (confirmation == JOptionPane.YES_OPTION) {
            try {
                ...
                if (deleted) {
                    ...
                    JOptionPane.showMessageDialog(this, "Machine successfully Deleted");
                } else {
                    JOptionPane.showMessageDialog(this, "Delete failed.", "Delete Error", JOptionPane.ERROR_MESSAGE);
                }
            } catch (RemoteException ex){
                Logger.getLogger(MachineForm.class.getName()).log(Level.SEVERE, null, ex);
            }
